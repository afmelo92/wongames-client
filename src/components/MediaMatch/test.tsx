...
describe('<MediaMatch />', () => {
  ...
  it('should show or hide based on the media passed', () => {
    ...
    expect(mobildeHeading.parentElement).toHaveStyleRule('display', 'block', {
